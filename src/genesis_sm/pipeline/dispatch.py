"""
genesis_sm.pipeline.dispatch — Agent dispatch via opencode CLI.
...
Usage:
    from genesis_sm.pipeline.dispatch import dispatch_sync, handshake_sync

Migrated from the project root (pipeline/dispatch.py) into the genesis-sm
