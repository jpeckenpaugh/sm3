Create a simple python state machine that can cycle the following states:
...
docs.md for BACKLOG, BRIEF, PLAN, ARCHITECT, PM
code.md for ENGINEER, TEST, DEVOPS, PM
