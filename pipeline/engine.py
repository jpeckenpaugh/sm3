"""
pipeline/engine.py — DB-driven state machine loop.
...
Usage (called from state_machine.py's run_with_config):
...
from state_machine import run_script, has_backlog, wait_for_signal
